...
public class ProductListController {
    ...
    @FXML
    private TableColumn<Product, String> halamanColumn;
    @FXML
    private TableColumn<Product, String> penerbitColumn;
    @FXML
    ...
    public void initialize() throws IOException {
        ...
        halamanColumn.setCellValueFactory(new PropertyValueFactory<>("halaman"));
